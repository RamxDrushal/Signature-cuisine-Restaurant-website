...
<section class="dashboard">
   ...
   <h1 class="heading">Signature cuisine Admin & staff Panal</h1>

   <div class="box-container">

   <div class="box">
    <h3>Admin & Restaurent staff</h3>
   ...
   <div class="box">
      ...
      <p>Admins and Staff</p>
      <a href="admin_accounts.php" class="btn">See Admins and Staff </a>
   </div>
